...
public class StateMachineComponentTest {
	...
	/**
	 * Checks if Setting and Getting States and Propagation to Observers
	 * works correctly. Also checks detaching Observer from State Machine.
	 */
	@Test
	public void testAllGameStates() {
		...
		assertEquals(State.GameNotStarted, this.stateMachine.getState());
		assertEquals(State.GameNotStarted, observer.getCurrentState());
		...
		this.stateMachine.setState(State.GameNotStarted);
